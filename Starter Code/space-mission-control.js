...
function startMonitoring() {
     ...
     monitoringTaskId = setInterval(() => {
          ...
          if (randomNumber > 0.05) {
               console.log("Systems are stable");
          } else {
...
function scheduleMission() {
     ...
     console.log("Starting Pre-Launch System Check.");
     startMonitoring();

     addOneTimeTask(
          () => console.log("Pre-launch system check completed."),
          10000
     );
     addOneTimeTask(stopMonitoring, 10001);
     addOneTimeTask(() => startCountdown(10), 11000);
     runOneTimeTasks();
}
